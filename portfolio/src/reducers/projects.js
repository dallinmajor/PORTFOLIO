...
export default () => {
    return [{
        ...
        description: 'This site scraps the latest news stories from KSL and allows users to comment on them.',
        createdAt: '8/29/2018',
        gitHubLink: 'https://github.com/dallinmajor/Newsy',
        projectLink: 'https://infinite-sea-54900.herokuapp.com/'
    },{
